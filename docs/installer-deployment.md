...
Step-by-step guide for deploying OpenClaw on an OpenShift cluster using the [openclaw-installer](https://github.com/aakankshaduggal/openclaw-installer). This is the recommended deployment method — it handles OAuth proxy, ServiceAccounts, Routes, and lifecycle management automatically.
...
| openclaw-installer | https://github.com/aakankshaduggal/openclaw-installer |
